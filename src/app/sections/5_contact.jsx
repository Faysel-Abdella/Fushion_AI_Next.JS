...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://sending-email-for-my-portfolio-2.onrender.com/send-email",
        {
          method: "POST",
          headers: {
      ...
      toast.success("Thanks, I will get in touch with you shortly.", {
        autoClose: 4000,
      });
  ...
  return (
    <>
      <section
        className="max-container bg-dark py-20 lg:py-[120px] overflow-hidden relative z-10 font-poppins"
        id="contact"
      >
        <div className="container">
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0 max-md:px-3">
                <span className="block mb-4 text-base font-semibold text-primary">
                  Schedule a Consultation
                </span>
                <h2 className="mb-6 text-[32px] font-bold uppercase text-[#f0f0f0] sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  GET IN TOUCH WITH US
                </h2>
                <p className="text-base leading-relaxed mb-9 text-slate-400">
                  Interested in learning more about how Fushion AI can help you
                  make data-driven real estate decisions? Schedule a
                  consultation with one of our experts by filling out the form
                  below. We look forward to discussing your needs and exploring
                  how our advanced AI solutions can benefit your real estate
                  ventures.
                </p>
                {/* <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold text-[#f0f0f0]">
                      My Location
                    </h4>
                    <p className="text-base text-slate-400">Adama, Ethiopia</p>
                  </div>
                </div> */}
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-slate-400">+31 (6) 11082835</p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-blue-950 rounded-lg shadow-lg sm:p-12">
                <form onSubmit={handleSubmit}>
                  ...
                  <ContactInputBox
                    ...
                    onChangeForm={(e) => setPhone(e.target.value)}
                    inputValue={phone}
                  />
                  <ContactTextArea
                    row={parseInt("6")}
                    ...
                    name="details"
                    defaultValue=""
                    onChangeForm={(e) => setMessage(e.target.value)}
                    inputValue={message}
                  />
                  <div>
                    <button
    ...
    <>
      <div className="mb-6">
        <textarea
          ...
          name={name}
          className="border-slate-600 w-full resize-none rounded border py-3 px-[14px] text-base text-[#f0f0f0] outline-none focus:border-primary focus-visible:shadow-none bg-black"
    ...
    <>
      <div className="mb-6">
        <input
          ...
          onChange={onChangeForm}
          value={inputValue}
          className="border-slate-600 w-full rounded border py-3 px-[14px] text-base  outline-none focus:border-primary focus-visible:shadow-none text-[#f0f0f0] bg-black"
        />
      </div>
    </>
  );
